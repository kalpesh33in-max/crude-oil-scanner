...
# Buffer to store incoming alerts
alerts_buffer = []
...
def parse_alert(text):
    ...
    # Logic for Options Action Mapping
    ...
    # Logic for Futures Action Mapping
...
async def process_summary(context: ContextTypes.DEFAULT_TYPE):
    ...
    # Build the HTML pre-formatted report
    message = "<pre>\n📊 2 MIN FLOW REPORT\n\n"
...
def main():
    ...
    if app.job_queue:
        # Run process_summary every 120 seconds
